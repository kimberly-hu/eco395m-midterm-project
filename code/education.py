...
# attach region (city) names to campus reference
...
campus_reference_data_1 = campus_reference_data.merge(regions_info[['REGION_str', 'CITY']], 
                                                      how='left', 
                                                      left_on = 'REGION',
                                                      right_on = 'REGION_str'
                                                     )
...
print(campus_reference_data_1.head(5))


# rename columns for campus reference
...
academic_data_1 = academic_data[['CAMPUS', 'CDA00AA11219R', 'CDA00ABI1219R', 'CDA00AR11219R', 'CDA00AUS1219R']]

academic_colnames = {'CAMPUS': 'Campus', 
...
# remove observations missing rate data
...
print(academic_data_2.head(5))


# keep relevant columns in staff data

staff_col_drop = ['CPCTG01A', 'CPCTG02A', 'CPCTG03A', 'CPCTG04A', 'CPCTG05A', 'CPCTG06A', 'CPCTGKGA', 'CPCTGMEA', 'CPCTFLAA']
...
education_data = academic_data_2.merge(staff_data_1, 
                                       how='left', 
                                       on = 'Campus')

education_data = education_data.merge(campus_reference_data_1,
                                     how='left',
                                     on='Campus')
