...
# US_History_Rate and Class_Size_Soc_Stud

x = all_data['Class_Size_Soc_Stud']
y = all_data['US_History_Rate']

plt.scatter(x, y, alpha=0.5)

# Add labels and a title
plt.xlabel('Class_Size_Soc_Stud')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Class_Size_Soc_Stud')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Class_Size_Soc_Stud.png')
plt.clf()




# US_History_Rate and Teacher_Student_Ratio
...
plt.xlabel('Teacher_Student_Ratio')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_Student_Ratio')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_Student_Ratio.png')
plt.clf()




# US_History_Rate and Teacher_Beginning_Percent
...
plt.xlabel('Teacher_Beginning_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_Beginning_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_Beginning_Percent.png')
plt.clf()




# US_History_Rate and Teacher_1-5_Years_Percent
...
plt.xlabel('Teacher_1-5_Years_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_1-5_Years_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_1-5_Years_Percent.png')
plt.clf()



# US_History_Rate and Teacher_6-10_Years_Percent
...
plt.xlabel('Teacher_6-10_Years_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_6-10_Years_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_6-10_Years_Percent.png')
plt.clf()



# US_History_Rate and Teacher_11-20_Years_Percent
...
plt.xlabel('Teacher_11-20_Years_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_11-20_Years_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_11-20_Years_Percent.png')
plt.clf()




# US_History_Rate and Teacher_More_Than_20_Years_Percent
...
plt.xlabel('Teacher_More_Than_20_Years_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_More_Than_20_Years_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_More_Than_20_Years_Percent.png')
plt.clf()




# US_History_Rate and Teacher_Experience_Average
...
plt.xlabel('Teacher_Experience_Average')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_Experience_Average')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_Experience_Average.png')
plt.clf()



# US_History_Rate and Teacher_BA_Degree_Percent
...
plt.xlabel('Teacher_BA_Degree_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_BA_Degree_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_BA_Degree_Percent.png')
plt.clf()




# US_History_Rate and Teacher_MS_Degree_Percent
...
plt.xlabel('Teacher_MS_Degree_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_MS_Degree_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_MS_Degree_Percent.png')
plt.clf()




# US_History_Rate and Teacher_No_Degree_Percent
...
plt.xlabel('Teacher_No_Degree_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_No_Degree_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_No_Degree_Percent.png')
plt.clf()




# US_History_Rate and Teacher_PH_Degree_Percent
...
plt.xlabel('Teacher_PH_Degree_Percent')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_PH_Degree_Percent')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_PH_Degree_Percent.png')
plt.clf()




# US_History_Rate and Teacher_Tenure_Average
...
plt.xlabel('Teacher_Tenure_Average')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Teacher_Tenure_Average')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Teacher_Tenure_Average.png')
plt.clf()




# US_History_Rate and Median_Household_Income
...
plt.xlabel('Median_Household_Income')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Median_Household_Income')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Median_Household_Income.png')
plt.clf()




# US_History_Rate and Gini_Index
...
plt.xlabel('Gini_Index')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Gini_Index')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Gini_Index.png')
plt.clf()




# US_History_Rate and Median_Family_Income
...
plt.xlabel('Median_Family_Income')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Median_Family_Income')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Median_Family_Income.png')
plt.clf()




# US_History_Rate and Poverty_Rate
...
plt.xlabel('Poverty_Rate')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Poverty_Rate')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Poverty_Rate.png')
plt.clf()




# US_History_Rate and Avg_Max_Temp
...
plt.xlabel('Avg_Max_Temp')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Avg_Max_Temp')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Avg_Max_Temp.png')
plt.clf()




# US_History_Rate and Avg_Min_Temp
...
plt.xlabel('Avg_Min_Temp')
plt.ylabel('US_History_Rate')
plt.title('Scatter Plot: US_History_Rate vs. Avg_Min_Temp')

plt.savefig('artifacts/scatter_plots/US_History_Rate_vs_Avg_Min_Temp.png')
plt.clf()